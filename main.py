...
BACKGROUND_MUSIC = pygame.mixer.Sound(os.path.join('Assets', 'Dearly+Beloved.mp3'))
BACKGROUND_MUSIC.play()

HEALTH_FONT = pygame.font.SysFont('comicsans', 40)
WINNER_FONT = pygame.font.SysFont('comicsans', 100)

# Changing FPS and Spaceship styles
FPS = 60
VEL = 5
BULLET_VEL = 7
MAX_BULLETS = 3
...
# Loading spaceship images and scaling
YELLOW_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'spaceship_yellow.png'))
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)

RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'lief.png'))
...
# Moving bullets and checking collisions
